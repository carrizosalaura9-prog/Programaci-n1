...
def obtener_intento_usuario():
    while True:
        ...
        if len(intento) != LONGITUD_CODIGO:
            print(Fore.RED+f"Error: el codigo debe de tener {LONGITUD_CODIGO} letras"+Style.RESET_ALL)
            continue
...
def jugar():
    ...
    while intentos_restantes > 0:  
        print(f"Te quedan {Fore.YELLOW+Style.BRIGHT}{intentos_restante}{Style.RESET_ALL} intentos")
